"""
Purpose: Configure the canonical Celery worker runtime without importing task modules.
Scope: Worker app construction, trace-aware task execution, retry logging, and runtime probe task.
