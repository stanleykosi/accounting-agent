    ...
    <main className="setup-shell">
      <section className="setup-hero-grid">
        <div className="setup-hero-copy">
          ...
          <h1>Validate the local accounting runtime before you enter the workspace.</h1>
          <p className="lede">
            The packaged desktop shell runs the Next.js UI locally and fails closed when the demo
            stack is unavailable. Start the canonical services first so close-run review, evidence
            tracing, and background jobs all land on one healthy path.
          </p>
        </div>
        ...
        <SurfaceCard title="Required services" subtitle="Why the shell pauses here" tone="accent">
          <div className="detail-block">
            <p className="form-helper">
              The setup gate checks the loopback API, MinIO object storage, PostgreSQL, and Redis
              before the main workflow UI opens.
            </p>
