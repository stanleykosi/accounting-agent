...
def _write_cover_sheet(workbook: Any, formats: ReportFormats, input_data: ExcelReportInput) -> None:
    ...
    if input_data.generated_at:
        ...
        ws.write('B8', _normalize_excel_datetime(input_data.generated_at), formats.date)
...
def _normalize_excel_datetime(value: datetime) -> datetime:
    """Convert an aware timestamp into a naive UTC datetime for Excel compatibility."""
